    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Accepter', 'Accepté'), ('Emballer', 'Emballé'), ('En Route', 'En Route'), ('Livrer', 'Livré'), ('Annuler', 'Annulé'), ('En Attente', 'En Attente')], default='En attente', max_length=50)),
